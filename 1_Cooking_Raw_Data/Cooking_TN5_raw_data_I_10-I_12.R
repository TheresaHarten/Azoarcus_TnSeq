...
for(TN5 in c("10", "11", "12")){
  
  i <- i+1
  
  TN5_forward <- read.csv(paste("./0_Data/Tn5_Ferm_I_10-I_12/Tn5_I_", 
  ...
  TN5_reverse <- read.csv(paste("./0_Data/Tn5_Ferm_I_10-I_12/Tn5_I_", 
  ...
  write_csv(TN5_new, 
            path = paste("./0_Data/Tn5_Ferm_I_10-I_12/Tn5_Ferm_I_", 
...
names(TN5_data) <- paste("I_", c(10, 11, 12), sep = "")
...
write_csv(Ins_Data, 
          path ="./0_Data/Tn5_Ferm_I_10-I_12/Tn5_Ferm_I_10-I_12_list_ins_combined.csv")
