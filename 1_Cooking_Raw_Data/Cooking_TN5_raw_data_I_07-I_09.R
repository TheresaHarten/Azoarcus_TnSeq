...
for(TN5 in c("07", "08", "09")){
  
  i <- i+1
  
  TN5_forward <- read.csv(paste("./0_Data/Tn5_Ferm_I_07-I_09/Tn5_I_", 
  ...
  TN5_reverse <- read.csv(paste("./0_Data/Tn5_Ferm_I_07-I_09/Tn5_I_", 
  ...
  write_csv(TN5_new, 
            path = paste("./0_Data/Tn5_Ferm_I_07-I_09/Tn5_Ferm_I_", 
...
names(TN5_data) <- paste("I_", c(07, 08, 09), sep = "")
...
write_csv(Ins_Data, 
          path ="./0_Data/Tn5_Ferm_I_07-I_09/Tn5_Ferm_I_07-I_09_list_ins_combined.csv")
