...
#### Master library  with index 13-19
...
Ins_Data <- read_csv(paste("./0_Data/Tn5_Library_I_13-I_19/Tn5_", TN5, 
...
write_csv(translation_data, 
          paste("./99_Results/2_Find_Translationframe/Translation_IS_", TN5, ".csv", sep=""))
